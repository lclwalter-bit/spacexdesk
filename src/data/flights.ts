...
export const cadenceNotes = [
  'Musk: once Starship flies reliably several times per week → wind down Falcon engineering/production toward multi-flight/day Starship.',
  'Target ~1,000 Starlink V3 by ~Q2 2027 for bandwidth step-change / DTC expansion.',
  'Starbase Louisiana announced for high-cadence Starship (construction ~2027, launches earliest ~2029).',
]
